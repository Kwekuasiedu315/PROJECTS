"""
Django settings for aska project.
...
SECRET_KEY = "django-insecure-^svlu8ozwv5w6980gakrh8p!cfhxh6y$*^&pzzx)9^^nj63(%q"
...
WSGI_APPLICATION = "aska.wsgi.application"
