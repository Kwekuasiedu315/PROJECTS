...
from records.models import CustomUser, Friendship, School
from records.users.serializers import UserSerializer, FriendshipSerializer
from records.schools.serializers import School, SchoolSerializer
